...
# Now we get to see if my model is crap or not (in the console first, for my own benefit)
...
def overlay_predictions(image_path, model, class_names, true_label, output_path):
    ...
    # Adding labels: model, true, then predicted, then confidences
    cv2.putText(img, "Model used: LifeIsSoupIAmFork", (10, y_offset), font, font_scale, (0, 0, 0), thickness)
...
true_label = "crack"  
output_path = "LifeIsSoup_test-crack-result.png"
...
output_path = "LifeIsSoup_test-headoff-result.png"
...
output_path = "LifeIsSoup_test-paintchip-result.png"
